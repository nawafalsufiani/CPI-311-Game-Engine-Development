...
namespace CPI311.Labs
{
    public class Lab06 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.DrawString(font, "Calculating the number of Collisions: " + lastSecondCollisions, Vector2.Zero, Color.Black);
            spriteBatch.DrawString(font, "Press Space to Add Sphear ", new Vector2(0, 40), Color.Black);
            spriteBatch.DrawString(font, "The cnumber of Sphear " + SphereCounter, new Vector2(0,60), Color.Black);
            spriteBatch.End();
            base.Draw(gameTime);
        }
