...
namespace CPI311.Labs
{
    public class Dot : GameObject
    {
        ...
        public Dot(TerrainRenderer terrain, ContentManager Content,
            Camera camera, GraphicsDevice graphicsDevice, Light light, Player theplayer) : base()
        {
            ...
            pacManEat = Content.Load<SoundEffect>("pacman_chomp");
            Renderer renderer = new Renderer(
                Content.Load<Model>("dots"), Transform, camera, Content, graphicsDevice, light,
                1, "SimpleShading", 20f, texture);

            renderer.Material.Diffuse = Color.Green.ToVector3();
            renderer.Material.Specular = Color.Green.ToVector3();
            renderer.Material.Ambienet = Color.Green.ToVector3();
        ...
        public override void Update()
        {
            ...
            {
                FinalProject.currentScore = FinalProject.currentScore + 5;
