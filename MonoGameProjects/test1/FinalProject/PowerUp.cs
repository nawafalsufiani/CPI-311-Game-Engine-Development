...
namespace CPI311.Labs
{
    public class PowerUp : GameObject
    {
        ...
        // Audio components
        SoundEffect pacManEat, normalGhostMoviment;
        SoundEffectInstance soundInstance;
        public static bool PowerStatus = false;
        public PowerUp(TerrainRenderer terrain, ContentManager Content,
            Camera camera, GraphicsDevice graphicsDevice, Light light, Player theplayer) : base()
        {
            ...
            SoundEffectInstance soundInstance = normalGhostMoviment.CreateInstance();
           ...
           // soundInstance.Play();
            ...
            pacManEat = Content.Load<SoundEffect>("Ghost： Turn to Blue");
            Renderer renderer = new Renderer(
                Content.Load<Model>("Sphere"), Transform, camera, Content, graphicsDevice, light,
                1, "SimpleShading", 20f, texture);

            renderer.Material.Diffuse = Color.Red.ToVector3();
            renderer.Material.Specular = Color.Red.ToVector3();
            renderer.Material.Ambienet = Color.Red.ToVector3();
        ...
        public override void Update()
        {
            ...
            {
                PowerStatus = true;
                FinalProject.currentScore= FinalProject.currentScore + 10;
                DestroyObject();
